...
For all three generators, the events were then passed through a full \geant~\cite{GEANT4} simulation of the sPHENIX detector and reconstruction chain to produce detector-level objects comparable to those in data.
...
As a first step in this reweighting procedure, the nominal discrepancy between the final state particle spectra from the MC generators used in this analysis and previous measurements at RHIC from PHENIX and STAR was investigated. 
