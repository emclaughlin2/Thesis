...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{ueinpp/Figures/mbd_waveforms_pileup/UE_spectra_sim_vs_49219.pdf}
...
\begin{figure}
    ...
    \centering
      \includegraphics[width=1.\textwidth]{ueinpp/Figures/mbd_waveforms_pileup/MBD_2D_evt2852759.pdf}
    \end{subfigure}
    \begin{subfigure}{.329\textwidth}
    \centering
        \includegraphics[width=1.\textwidth]{ueinpp/Figures/mbd_waveforms_pileup/MBD_2D_evt1296477.pdf}
    \end{subfigure}
    \begin{subfigure}{.329\textwidth}
    \centering
        \includegraphics[width=1.\textwidth]{ueinpp/Figures/mbd_waveforms_pileup/MBD_2D_evt2052513.pdf}
    \end{subfigure}
