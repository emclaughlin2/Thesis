\subsection{Simulation-Based Non Collision Background Cuts and Efficiencies}
...
\begin{itemize}
    \item The first method, referred to as the “energy fraction" requirement, applies selections on the fraction of reconstructed jet energy deposited in each calorimeter layer. Specifically, the EMCal and OHCal fractions, $E_{EMCal}/E_{Jet}$ and $E_{OHCal}/E_{Jet}$, must be between 10\% and 90\%, while the IHCal fraction, $E_{IHCal}/E_{Jet}$, must lie between 0\% and 90\%. This method would require a simulation-based correction for this jet selection inefficiency and is therefore sensitive to the \geant modeling of the longitudinal shower deposition in simulation.
...
\begin{figure}
    ...
    \caption{Timing cut efficiencies shown as a function of leading jet $p_{T}$ for events passing the leading jet time (left) and the leading jet--MBD (right) time cuts. Cut efficiencies for nominal timing cuts shown in red and efficiencies for the timing cut variation are shown in blue.}
...
\begin{figure}
    ...
    \caption{Timing cut purities shown as a function of leading jet $p_{T}$ for events passing the leading jet time (left) and the leading jet--MBD (right) time cuts. Cut purities for nominal timing cuts shown in red and purities for the timing cut variation are shown in blue.}
