...
\begin{figure}
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/chapter2/emcal_ihcal_ohcal.png} 
        \caption{Installed EMCal, IHCal and OHCal}
    \end{subfigure}
    \begin{subfigure}{0.5\linewidth}
        \centering  
        \includegraphics[width=\linewidth]{figures/chapter2/sphenix_ihcal_magnet_ohcal.png} 
...
\begin{figure}
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/chapter2/emcal_towers.png} 
        \caption{EMCal Sector Schematic}
    \end{subfigure}
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/chapter2/ohcal_tiles.png}   
