...
\begin{figure}
    ...
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/tpot_schematic.png}
        \caption{TPOT schematic}
    \end{subfigure}
    \begin{subfigure}{0.35\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/tpot_for_tracking_correction.png}
        \caption{Track Reconstruction Corrections with TPOT}
    \end{subfigure}
    \hfill
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=0.8\linewidth]{Figures/tpot_micromegas.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/mbd_schematic.png}
