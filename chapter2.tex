...
Each layer of silicon barrel is composed of a set of staves, for a total of 48 staves, which each contain a hybrid integrated circuit with a flexible printed circuit connected to nine ALICE Pixel Detector (ALPIDE) pixel chip sensors, for a total of 432 ALPIDE sensors.
...
\textcolor{red}{Add in pictures of MVTX}\textcolor{red}{Add in reference for MVTX}

The TPC is the main sPHENIX tracking subdetector, spanning in radial distance from 20 to 80 cm with 

Gaseous Drift Detectors
- Big cylinder filled with (mostly)
noble gas (Ne, Ar, etc...) and
electric field
- Particles come in, ionize gas,
make electroncs (and ions)
- Electrons drift to anode plane
– are read out
...
\textcolor{red}{Add in sentence about calorimeter necessary for jet physics goals}
