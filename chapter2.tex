...
During 2024, RHIC provided both proton-proton and \auau{} collisions at 200 GeV and sPHENIX's collected datasets from these collision systems are used in measurements presented in Chapters \ref{sec:chapter4} and \ref{sec:chapter5}.
...
The arc sections are each composed of 11 focusing quadrupole, drift space, defocusing quadrupole, drift space (FODO) cells and the beams are separated by 90 cm horizontally within the arc sections.
...
\begin{figure}
    ...
    \caption{Schematic of RHIC acceleration chain for Au beams. Reproduced from \cite{rhic_overview}.}
...
In 2024, sPHENIX took its premire physics dataset of \pp{} collisions at $\sqrt{s} = 200$ GeV sampling over 100 pb$^{-1}$ allowing for precision jet measurements in \pp{} collisions at RHIC energies.
...
\begin{figure}
    ...
    \begin{subfigure}{0.35\linewidth}
        ...
        \caption{Track Reconstruction Corrections}
    \end{subfigure}
    \hfill
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/chapter2/tpot_micromegas.png}
        \caption{TPOT Micromegas chamber}
    \end{subfigure}
...
sPHENIX is designed with a state of the art data aquisition system and computing resources to collect data at very high rates which is necessary to achieve its data-intensive physics goals within its short three year running period.
The sPHENIX data aquisition system is designed to readout data from triggered calorimeter events at a rate of 15 kHz in both \pp{} and \auau{} collisions and read out tracking detectors in full streaming mode collecting all of the supplied collision data.
