...
The jet and calorimeter cluster calibration and selection efficiency uncertainties are treated as uncorrelated. 
This is a reasonable method for this analysis since the dominant calorimeter cluster and jet uncertainties have largely distinct physical origins: calorimeter cluster uncertainties are primarily driven by low-energy effects such as noise and pileup, whereas the jet energy scale is constrained using an in-situ photon-jet calibration and is expected to be relatively insensitive to these contributions for jets with reconstructed $p_{T} > 21$ GeV. 
Any residual correlation between these sources is therefore expected to be small compared to the overall systematic uncertainty.
The dominant contributions to the total systematic uncertainty arise from the calorimeter cluster hadronic response, pileup correction and noise effects, while jet calibration and selection efficiency uncertainties are generally subdominant. 
In addition, the impact of noise and pileup on jets in the kinematic region considered is expected to be small, and the calorimeter hadronic response is reasonably well constrained at jet energies above 20 GeV by photon-jet calibration studies.
...
The JES uncertainty is derived from the scale difference between data and MC in the in-situ photon-jet calibration studies~\cite{in_situ_note} and results in a $p_{T}$-independent 2.5\% uncertainty on the jet energy scale. 
...
The jet trigger efficiency is derived by varying the fit parameters of the jet trigger efficiency fit function outlined in Section~\ref{sec:jet_trigger_eff} by to find the 1$\sigma$ variations on the parameterized jet trigger efficiency. THe jet trigger efficiency uncertainty is found to be negligible for the UE measurement with variations at the $<$ 1\% level.
...
In particular, varying the seeding requirements provides a test of the robustness of the truth-level results with respect to the reconstruction-level low-energy fiducial selection. 
...
The overall effect of this topocluster noise threshold variation on the UE measurement is found to be at the 3-4\% level when varying up and down to the $2\sigma_{ped}$ and $4\sigma_{ped}$ thresholds defined in Section~\ref{sec:ueinpp_towerreco}.
...
The overall effect of the pileup correction on the UE measurement is found to be $< 5\%$ for all leading jet $p_T$ bins.
...
The largest sources of uncertainty are from the uncertainties in the calorimeter hadronic response, and the variations in the pileup correction and the topocluster noise threshold.
\begin{figure}
    \centering
    \includegraphics[width=0.48\linewidth]{ueinpp/Figures/systematics/h_syst_profile_inclusive.png}
    \includegraphics[width=0.48\linewidth]{ueinpp/Figures/systematics/h_syst_profile_dijet.png}
