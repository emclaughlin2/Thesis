...
\begin{figure}
    \centering
    \includegraphics[width=0.32\linewidth]{ueinpp/Figures/initial_studies/h_jetspectra.png}
    \includegraphics[width=0.32\linewidth]{ueinpp/Figures/initial_studies/h_deltaphi.png}
    \includegraphics[width=0.32\linewidth]{ueinpp/Figures/initial_studies/h_xj.png}
