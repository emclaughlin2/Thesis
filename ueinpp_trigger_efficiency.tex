...
\begin{figure}
    ...
    \caption{Comparison of the "MB" (black) and "MB + Jet" trigger events for Jet8 (red), Jet10 (blue) and Jet12 (magneta).}
    \label{fig:mb_jet_spectra}
\end{figure}

\subsubsection{Run-by-Run Stability}

Run-by-run differences in the efficiency arise from changes in the calorimeter response and calibration across the full Run 2024 p+p dataset.
...
%\begin{figure}
%    \centering
%    \includegraphics[width=\linewidth]{ueinpp/Figures/mbd_vertex_efficiency/vertex_eff_vs_zvertex_range.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{ueinpp/Figures/mbd_vertex_efficiency/vertex_eff_meas_range.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{ueinpp/Figures/mbd_vertex_efficiency/vertex_eff_pt_slices.png}
