...
Additionally, the MBD acts as a multiplicity counter, and therefore, the charge information is calibrated in terms of MIP counts.
...
Therefore, this 2\% difference in the minimum bias definition from this ZDC requirement is included in the uncertainty on the minimum bias trigger efficiency. 
...
The second part of the model samples multiplicity distributions from events with set nuclear geometry information, set $\Npart$ and $\Ncoll$, using a negative binomial distribution to get a realistic distribution of particle production and final state multiplicity.
