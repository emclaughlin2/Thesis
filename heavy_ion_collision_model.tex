...
The system goes through extreme changes in energy density and temperature through this evolution, therefore the system is best modeled through a combination of phenomenological models~\cite{Busza_2018}. 
...
Here, the QGP phase is modeled using a variety of equations of state~\cite{eos_borsanyi2010qcd} and viscosity~\cite{viscosity_Bernhard:2019bmu,Dore:2020jye,McLaughlin:2021dph} terms as the system expands and cools.
...
\subsubsection{\epos}
\epos (Energy conserving quantum mechanical multiple scattering approach, based on Partons (parton ladders), Off-shell remnants, Splitting of parton ladders)~\cite{epos} uses an entirely different approach to modeling the inital stage of heavy ion collisions then \hijing and \ampt.
