The plots in Figures~\ref{fig:ep_resolution} and \ref{fig:ep_hadronic_dr02_e3gev} show the full comparison of the $\langle2\sigma_{ped}\rangle$, $\langle3\sigma_{ped}\rangle$, and $\langle4\sigma_{ped}\rangle$ thresholds outlined in Section~\ref{sec:topo_resolution} for EM and hadronic particles. 
