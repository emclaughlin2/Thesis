...
To limit noise contributions, the clustering algorithm uses the ratio of the tower's energy to its expected noise as a significance metric for seeding and expanding clusters.~\cite{ATLAS:2017_topological_cluster_performance,ATLAS:2024_topological_cluster_timing}. 
Topoclusters are then grown using the following thresholds:
\begin{itemize}
